...
from ..components import (
    clear_inline_preview, make_file_row, make_info_banner, make_preview_table, make_preview_header, make_status_chip, mark_file_button,
...
class ProjectStagesMixin:
    def _build_project_stages_tab(self):
        ...
        title = make_preview_header("Создание и обновление видов документов")
