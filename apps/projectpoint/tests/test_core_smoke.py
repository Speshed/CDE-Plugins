...
from projectpoint.excel import read_objects_import_excel, write_roles_import_template, read_roles_import_excel
...
class CoreSmokeTests(unittest.TestCase):
    ...
    def test_objects_example_import(self):
        records = read_objects_import_excel(ROOT / "examples" / "Объекты строительства.xlsx", "Импорт")
